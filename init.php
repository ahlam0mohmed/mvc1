...
// App Config
define("APP_NAME", "E-libraries");
define("APP_ROOT", ROOT . "app/");
define("APP_PROTOCOL", stripos($_SERVER["SERVER_PROTOCOL"], "https") === true ? "https://" : "http://");
define("APP_URL", APP_PROTOCOL . $_SERVER["HTTP_HOST"] . str_replace("app/public", "", dirname($_SERVER["SCRIPT_NAME"])) . "/");
define("APP_CONFIG_FILE", APP_ROOT . "config.php");

// Public Config
define("PUBLIC_ROOT", ROOT . "app/public/css/");
